...
public class Banner extends FrameLayout implements OnPageChangeListener {
    ...
    private int rLHeight;//底部的点距离底部的高度
    ...
    private void initView(Context context, AttributeSet attrs) {
        ...
        indicatorRl = (RelativeLayout) view.findViewById(R.id.circleIndicator_rl);
        //设置高度
        RelativeLayout.LayoutParams params = (RelativeLayout.LayoutParams) indicatorRl.getLayoutParams();
        params.bottomMargin = rLHeight;
        indicatorRl.setLayoutParams(params);
    ...
    private void handleTypedArray(Context context, AttributeSet attrs) {
        ...
        rLHeight = typedArray.getDimensionPixelSize(R.styleable.Banner_bottom_height, BannerConfig.INDICATOEHIGHT);
