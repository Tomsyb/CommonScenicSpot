...
public final class ActivityUtils {
    ...
    public static boolean isActivityExists(@NonNull final String pkg,
        ...
        return !(InitUtils.getContext().getPackageManager().resolveActivity(intent, 0) == null ||
                intent.resolveActivity(InitUtils.getContext().getPackageManager()) == null ||
                InitUtils.getContext().getPackageManager().queryIntentActivities(intent, 0).size() == 0);
    }
    ...
    public static String getLauncherActivity() {
        return getLauncherActivity(InitUtils.getContext().getPackageName());
    }
    ...
    public static String getLauncherActivity(@NonNull final String pkg) {
        ...
        PackageManager pm = InitUtils.getContext().getPackageManager();
    ...
    public static Drawable getActivityIcon(final Class<?> clz) {
        return getActivityIcon(new ComponentName(InitUtils.getContext(), clz));
    }
    ...
    public static Drawable getActivityLogo(final Class<?> clz) {
        return getActivityLogo(new ComponentName(InitUtils.getContext(), clz));
    }
    ...
    private static Context getActivityOrApp() {
        ...
        return topActivity == null ? InitUtils.getContext() : topActivity;
    }
     ...
     * @param clz
     */
    public static void startHtmlActivity(@NonNull final String htmlurl,
                                     @NonNull final Class<?> clz) {
        Bundle bundle = new Bundle();
        bundle.putString(Constant.HTML_URL,htmlurl);
        Context context = getActivityOrApp();
        startActivity(context, bundle, context.getPackageName(), clz.getName(), null);
    }
    /**
     * 跳监控
     * @param url
     * @param clz
     */
    public static void startVideoActivity(@NonNull final String url,
                                         @NonNull final Class<?> clz) {
        Bundle bundle = new Bundle();
        bundle.putString(Constant.VIDEO_PATH,url);
        Context context = getActivityOrApp();
        startActivity(context, bundle, context.getPackageName(), clz.getName(), null);
    }
